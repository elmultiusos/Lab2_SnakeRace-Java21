...
import javax.swing.ActionMap; // Para pausar y reanudar las serpientes
...
public final class SnakeApp extends JFrame {
    ...
    private final Semaphore pauseSignal = new Semaphore(1); // Semáforo para pausar y reanudar las serpientes
    ...
    public SnakeApp() {
        ...
        snakes.forEach(s -> exec.submit(new SnakeRunner(s, board, pauseSignal)));

        actionButton.addActionListener((ActionEvent e) -> {
            if ("Action".equals(actionButton.getText())) {
                actionButton.setText("Resume");
                pauseSignal.drainPermits(); // pausa
            } else {
                actionButton.setText("Action");
                if (pauseSignal.availablePermits() == 0) {
                    pauseSignal.release(); // resume
